...
// Consider updating the introduction since it is an update of my original post
...
Lucky for you, it is a clear message and should point you in the correct direction. If you ever get around to looking into the Corda codebase then you will see that the inbuilt states that have their own contracts are written like the example above.
...
You obviously don't have to write in the exact same way. I have split the `call` function into a load of smaller functions. It does actually make the code a lot longer. But, I don't think it can get any easier to read than that.
